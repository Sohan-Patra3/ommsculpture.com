...
if ($image) {
    $image_path = 'admin/uploadimage/galleryimg/' . $image['image'];
?>
        ...
        <div class="container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-5">
            <div class="row flex-lg-row align-items-center g-5 py-5 my-5" style="width: 90%;">
                <div class="col-8 col-sm-6 col-lg-4" style="top: 0; left: 0; width: 100%; height: 100%; opacity: 1;">
                    <img src="<?php echo $image_path; ?>" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes"
                        style="width: 100%; max-height:450px;" loading="lazy">
                </div>
                <div class="col-lg-6">
                    <h2 class="display-5 fw-bold text-body-emphasis lh-1 mb-3 "> <label for="name">Name -</label>
                        <?php echo $image['name'] ?></h2>
                    <h3 class="display-5 fw-bold text-body-emphasis lh-1 mb-3 "><label for="address">Address -</label>
                        <?php echo $image['address'] ?></h3>
                    <p class="lead text-dark"><label for="review">Review -</label>
