(function ($) {
    ...
    -------------------------------------*/
   /* $('body').on('contextmenu', function (e) {class="logo-mobile"
        e.preventDefault();
        e.stopPropagation();
        return false;
       });
...
*/
    ...
    // jQuery MeanMenu activation code
     --------------------------------------*/
    $('nav#dropdown').meanmenu({siteLogo: "<div class='mobile-menu-nav-back'><a href='index.php' class='logo-mobile'><img src='../img/logo.png' style='max-width: 100%;height: 30px;' /></a></div>"});
