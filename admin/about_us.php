			...
			<div class="col-sm-12 col-md-8 col-lg-8 ">
				<div class="card shadow mb-4">
					...
					<div class="card-body">
						...
						?>				
						<form method="post" action="about_us_a.php" enctype="multipart/form-data">
										...
										if($_GET['status'] ==200)
										{
											...
											<div class="c-msg">
												<div class="alert alert-success myMessage">
													<strong>Success!</strong> About Us Added Successfully !.
												</div>	
											</div>
											<?php 
										}	
										...
										if($_GET['status'] ==201)
										{
											...
											<div class="c-msg">
												<div class="alert alert-warning myMessage">
													<strong>Success!</strong> About Us Updated Successfully !.
												</div>	
											</div>
											<?php 
										}
							...
							<div class="form-group col-md-12">
								<div class="col-12">
									<textarea id="editor1" class="form-control form-control-sm" style="height:400px !important;" name="data"><?php echo isset($row)? $row['PAD_DESC']:'';?></textarea>
								</div>
							</div>
					...
					<div class="card-body">
						<div class="form-group col-md-12">
							<div class="col-md-12 ">
								...
								<small class="form-text text-muted">Image height Width (1600 X 500) px. Image Size (400 kb) kb.Image format(jpg,png,jpeg) </small>
							</div>
						</div>
						<div class="form-group col-md-12">
							<div class="col-md-12 ">
				...
				getCroppedImageBlob().then(function(blob)
				{
					...
					$.ajax(
					{
						...
						success: function (response) 
						{
							...
							const url="about_us.php?status="+status+"&page_id="+pageid;
