							...
							<div class="gradient-wrapper">
								<div class="gradient-title">
									...
									<p class="align-center">
										<i class="fa fa-edit text-success float-right" onclick="parent.location='https://www.ommsculpture.com/admin/about_us.php?page_id=1';" style="font-size: 25px; margin-top: -20px;"></i>
									</p>
									</h2>
								</div>
