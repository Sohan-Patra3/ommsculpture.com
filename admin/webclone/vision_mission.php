							...
							<div class="row no-gutters">
								<div class="col-lg-6 col-md-6 col-sm-6 col-6">
									<div class="top-bar-left">
										...
										<i class="fa fa-life-ring" aria-hidden="true"></i>Have any questions? +91 9437130468 or vikashcorporation@gmail.com                                    </p>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-6">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb--sm">
							<div class="gradient-wrapper">
								<div class="gradient-title">
									<h2 style="color:<?= ($settings['menutitle_color'])?$settings['menutitle_color']:""?>;font-size:<?= ($settings['menutitle_fontsize'])?$settings['menutitle_fontsize']:""?>;font-family:<?= ($settings['menutitle_fontfamily'])?$settings['menutitle_fontfamily']:""?>;"><?php echo $pageData['PAM_PANM'];?>
										<p class="align-center">
											<i class="fa fa-edit text-success float-right" onclick="parent.location='https://www.ommsculpture.com/admin/vision_mission.php?page_id=2';" style="font-size: 25px; margin-top: -20px;"></i>
										</p>
									</h2>
								</div>
								<div class="about-us gradient-padding">
									<img src="<?= $siteurl ;?>admin/uploadimage/<?php echo $pageData['PAD_IMG'];?>" alt="about" class="img-fluid w3-hide-small w3-hide-medium" style="width:1000px;height: 500px;">
									<img src="<?= $siteurl ;?>admin/uploadimage/<?php echo $pageData['PAD_IMG'];?>" alt="about" class="img-fluid w3-hide-large " style="width:1000px;height: 200px;">
