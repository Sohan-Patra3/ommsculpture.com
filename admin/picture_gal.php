<?php  
	...
	{
		$editid =$_GET['editid'];
		$sql ="SELECT * FROM picture_gal WHERE category_id=$editid and  orcd=$org_id";
...
<div class="container-fluid">
    ...
    <div class="row ">
        <div class="col-sm-12 col-md-8 col-lg-8 ">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><?php echo isset($editid)? $mode:'Add';?> Gallery
                        Image
                    </h6>
                </div>
                <div class="card-body">
                    <form method="post" action="picturegal_a.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-12">
                            <div class="col-md-12 ">
                                ...
                                <input type="text" class="form-control form-control-sm " name="title" id="title"
                                    value="<?php echo isset($editid)? $row['name']:'';?>" placeholder="Enter Name Here"
                                    required>
                            </div>
                        </div>
                        <div class="form-group col-md-12 ">
                            <div class="col-md-12 ">
                                ...
                                <input type="text" class="form-control form-control-sm" id="dip_order" name="dip_order"
                                    value="<?php echo isset($editid)?$row['address']:'';?>" required min="1" />
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                            <div class="col-12">
        ...
        <div class="col-sm-12 col-md-4 col-lg-4 ">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><?php echo isset($editid)? $mode:'Add';?> Image</h6>
                </div>
                <div class="card-body">
                    <div class="form-group col-md-12">
                        <div class="col-md-12 ">
                    ...
                    <div class="form-group col-md-12">
                        <div class="col-md-12 ">
                            <div class="form-group col-md-12 custom-file"
                                ...
                                <img src="uploadimage/galleryimg/<?php echo isset($editid)?$row['image']:'';?>"
    ...
    <div class="row ">
        <div class="col-sm-12 col-md-12 col-lg-12 ">
            <div class="card shadow mb-4 ">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Gallery Image list </h6>
                </div>
                <div class="card-body">
                    <?php 
							if(isset($_GET['status']))
                    ...
                    <div class="table-responsive ">
                        ...
                        <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
										$sl =1;
										$sql = "SELECT * FROM `picture_gal` WHERE  orcd=$org_id and status=1";
										$result = mysqli_query($conn, $sql);
                                ...
                                <tr align="">
                                    ...
                                    <td><img src="uploadimage/galleryimg/<?php echo $row['image'];?>"
        ...
        $.ajax({
            ...
            success: function(dataResult) {
                ...
                if (dataResult.statusCode == 200) {
                    //$(".dmsg").show();
                    //location.reload();
                    window.location.href = "picture_gal.php?page_id=24&status=203"
                }
            }
        });
    }
            ...
            getCroppedImageBlob().then(function(blob) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        const url = "picture_gal.php?status=" + status +
                            "&page_id=" + pageid;
