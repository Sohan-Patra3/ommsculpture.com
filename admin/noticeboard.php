...
<div class="container-fluid">
	...
	<div class="row ">
		...
		<div class="col-sm-12 col-md-8 col-lg-8 ">
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h6 class="m-0 font-weight-bold text-primary">Notice Board Lists </h6>
				</div>
				<div class="card-body">
					...
					<div class="table-responsive ">	
						...
						<table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
							...
							?>
								<tr align="">
									<th><?php echo $sl ;?></th>
									<td><?php echo $vrow['PAD_TITL'] ;?></td>
									<td><?php if($vrow['PAD_DESC'] == ""){ echo "Not Avaliable";}else{ echo $vrow['PAD_DESC'];} ;?></td>
									<td>
									<a href="uploadimage/<?php echo $vrow['PAD_IMG'] ?>" target="_blank">view file</a>
									</td>
									<td>
										<a href="<?php echo $_SERVER['PHP_SELF'];?>?editid=<?php echo $vrow['PAD_PGCD'];?>&page_id=<?php echo $page_id ;?>"><i class="fa fa-edit"></i></a> 
										<a href="noticeboard_a.php?delitid=<?php echo $vrow['PAD_PGCD'];?>" onclick="return confirm('Are you sure to remove <?php echo $vrow['PAD_TITL']." ?" ;?> ');"><i class="fa fa-trash text-warning"></i></a> 
									</td>
								</tr>
							<?php }?>
							</tbody>
		...
		<div class="col-sm-12 col-md-4 col-lg-4 ">
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h6 class="m-0 font-weight-bold text-primary"><?php echo isset($editid)? $mode:'Add';?>		Notice Board</h6>
				</div>
				<div class="card-body">
									
					<form method="post" action="noticeboard_a.php" enctype="multipart/form-data">
