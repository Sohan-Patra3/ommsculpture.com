<?php  
	...
	{
		$editid =$_GET['editid'];
		$sql ="SELECT * FROM category_mst WHERE category_id=$editid and  orcd=$org_id";
    ...
    <div class="row ">
        <div class="col-sm-12 col-md-8 col-lg-8 ">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="category-a.php" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group col-md-12">
                        <div class="col-md-12 ">
							...
							<br>
                            <small class="text-danger">Image height Width (420 X 220) px. Image
                                Size (400) kb.Image format(jpg,png,jpeg)</small>
                    ...
                    <div class="table-responsive ">
                        ...
                        <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
										$sl =1;
										$sql = "SELECT * FROM `category_mst` WHERE  orcd=$org_id and status=1";
										$result = mysqli_query($conn, $sql);
                                ...
                                <tr align="">
                                    ...
                                    <td><img src="uploadimage/<?php echo $row['image'];?>" alt="Service Image"
        ...
        $.ajax({
            ...
            success: function(dataResult) {
                ...
                if (dataResult.statusCode == 200) {
                    //$(".dmsg").show();
                    //location.reload();
                    window.location.href = "category.php?page_id=14&status=203"
                }
            }
        });
    }
    ...
    $("#btn-upload-image").on('click', function() {
        ...
        if (title == '') {
            ...
            getCroppedImageBlob().then(function(blob) {
                ...
                $.ajax({
                    type: "POST",
                    url: "ajax_crop_image_category.php",
                    data: formData,
                    dataType: "json",
                    contentType: false,
                    processData: false,
                    success: function(response) {
                        ...
                        const url = "category.php?status=" + status + "&page_id=" +
                            pageid;
