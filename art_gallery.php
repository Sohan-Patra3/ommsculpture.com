<?php
	...
	if($imgtypeid)
	{
		$Gsql ="SELECT * FROM `gal_dtl01` WHERE GAD_IMGTP=$imgtypeid AND GAD_SBCACD=$pageid AND GAD_CANC=0";
	}
	else
	{
		$Gsql ="SELECT * FROM `gal_dtl01` WHERE GAD_SBCACD=$pageid AND GAD_CANC=0";
	}
...
<section class="bg-accent-shadow-body fixed-menu-mt" style="padding-top: 1px;">
    <div class="container-img-txt">
        <img src="admin/uploadimage/<?php echo $rows['PAD_IMG'];?>" alt="about"
            class="img-fluid w3-hide-small w3-hide-medium" style="width:80%;height: 600px;">
        <div class="centered">
            <h1 style="color:white;text-align:center;">
                <? echo strtoupper($rows['PAD_TITL'])." STATUE GALLERY";?>
            </h1>
        </div>
    </div>
    <div class="container">
                    ...
                    <div class="gradient-title">
                        <div class="row">
                            <div class="col-12" style="text-align:center">
                                <h2
                                    style="color:<?= ($settings['menutitle_color'])?$settings['menutitle_color']:""?>;font-size:<?= ($settings['menutitle_fontsize'])?$settings['menutitle_fontsize']:""?>;font-family:<?= ($settings['menutitle_fontfamily'])?$settings['menutitle_fontfamily']:""?>;">
                                    <?php echo isset($_GET['pageid'])?$rows['PAD_TITL']." Statue Gallery":"Statue Gallery";?>
                                </h2>
                            </div>
                            <div class="col-8">
                            ...
                            <div class="col-5new col-md-3 col-sm-4 col-4">
                                <div class="product-box item-mb zoom-gallery">
                                    <div class="item-mask-wrapper">
                                        <div class="item-mask secondary-bg-box" style="height:370px; width:260px"><img
                                                src="admin/uploadimage/<?php echo $galrows['GAD_IMG'];?>"
                                                alt="categories" class="img-fluid" style="height:370px; width:260px">
                                            <div class="title-ctg" data-tips="Featured"> <i class="fa fa-bolt"
                                                    aria-hidden="true"></i></div>
                                            <ul class="info-link">
                                                <li>
                                                    <a href="admin/uploadimage/<?php echo $galrows['GAD_IMG'];?>"
                                                        class="elv-zoom" data-fancybox-group="gallery"
                                                        title="Title Here">
                                                        <i class="fa fa-eye" style="font-size:36px;color:white"
                                                            aria-hidden="true"></i>
                                                    </a>
                                                </li>
                                            </ul>
                ...
                <div class="sidebar-item-box">
                    <div class="gradient-wrapper">
                        ...
                        <ul class="sidebar-category-list">
                            ...
                            <li>
                                <a
                                    href="art_gallery.php?pageid=<?php echo base64_encode($pageid)?>&imgtypeid=<?php echo base64_encode($imgtyp);?>">
